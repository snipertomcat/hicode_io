		...
		<section class="hero_single version_2">
			<div class="wrapper">
				<div class="container">
					...
					<form method="GET" action="fgcourses-list.php">
						<div id="custom-search-input">
							<div class="input-group">
								<input type="text" name="skyd" class=" search-query" placeholder="Ex. Affiliate Marketing" value="<?php echo $searchword;?>">
				...
				<div class="col-xl-4 col-lg-6 col-md-6">
					<div class="box_grid wow">
						<figure class="block-reveal">
							...
							<a href="fgcourse-detail.php?id=<?php echo $str_jsonAry_decoded[$i]['id'];?>&skyd=<?php echo str_replace(' ','+',$searchword);?>"><img src="<?php echo $str_jsonAry_decoded[$i]['imgeurl'];?>" class="img-fluid" alt="" style="height:235px;"></a>
							<div class="price">
...
?>			
			<nav aria-label="..." class="text-center">
						<ul class="pagination pagination-sm">
							...
							<li class="page-item ">
								<a class="page-link" href="fgcourses-list.php?skyd=<?php echo str_replace(' ','+',$_GET['skyd']);?>&fcat=<?php echo $_GET['fcat']; ?>&skypage=<?php echo $m-1;?>" tabindex="-1">Previous</a>
							</li>

							<li class="page-item">
								<a class="page-link" href="fgcourses-list.php?skypage=<?php echo $m;?>&searchkey=<?php echo str_replace(' ','+',$_GET['skyd']);?>&fcat=<?php echo $_GET['fcat']; ?>"><?php echo $m;?></a>
							</li>
													
							<li class="page-item">
								<a class="page-link" href="fgcourses-list.php?skyd=<?php echo str_replace(' ','+',$_GET['skyd']);?>&fcat=<?php echo $_GET['fcat']; ?>&skypage=<?php echo $m+1;?>">Next</a>
							</li>
						</ul>
			</nav>
