...
$handle3 = curl_init();
$url = "https://app.sitecoursepro.com/site/posts.php";
...
<section id="hero_in" class="general">
			<div class="wrapper">
				<div class="container">
					<h1 class="fadeInUp"><span></span>Blog Details</h1>
				</div>
			</div>
		</section>
		<!--/hero_in-->
			...
			<div class="row">
				<div class="col-lg-9">
					<div class="bloglist singlepost">
						<p><img alt="" class="img-fluid" src="<?php echo $json3['post']['artimg'];?>"></p>
						<h1><?php echo $json3['post']['arttitle'];?></h1>
						<div class="postmeta">
							<ul>
